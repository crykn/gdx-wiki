...
- [ ] Figure out why **external link markers** are not appearing, when hosting via GH Pages; see [here](https://github.com/crykn/crykn.github.io/blob/dev/_plugins/external_links.rb)
