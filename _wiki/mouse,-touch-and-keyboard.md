...
permalink: /mouse,-touch-and-keyboard
---
...
Mouse and touch input can either be [polled](/wiki/polling) or processed via [Event Handling](/wiki/event-handling)
...
[Prev](/wiki/configuration-and-querying) | [Next](/wiki/polling)