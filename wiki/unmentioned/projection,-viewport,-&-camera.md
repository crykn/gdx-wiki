...
# Introduction
In the [MyFirstTriangle](/wiki/unmentioned/my-first-triangle-example) and [ColorMeshTexture](/wiki/unmentioned/mesh,-color-&-texture) tutorials, we learned the basics of setting up and rendering meshes. Did you notice, however, that the triangles we created appear stretched? Lets start with an example that will make this issue clear.

# Creating a Square

Create a new libGDX desktop project named `projection-viewport-camera`. Create a class called `ProjectionViewportCamera` that implements `ApplicationListener` and put it in the package `com.example.projectionviewportcamera`. For full instruction on how to set up a libGDX desktop (and Android) project, look at the [MyFirstTriangle](/wiki/unmentioned/my-first-triangle-example) tutorial. Unlike in that tutorial, we're going to show a square instead of a rectangle. Here's the code for `ProjectionViewportCamera`:
...
![images/projection_viewport_camera_rectangle.png](/assets/wiki/images/projection_viewport_camera_rectangle.png)
...
![images/projection_viewport_camera_normal_canvas.png](/assets/wiki/images/projection_viewport_camera_normal_canvas.png)

When we place out red square onto that area, the result looks like this:

![images/projection_viewport_camera_normal_square.png](/assets/wiki/images/projection_viewport_camera_normal_square.png)
...
![images/projection_viewport_camera_stretched_view.png](/assets/wiki/images/projection_viewport_camera_stretched_view.png)
...
![images/projection_viewport_camera_corrected_view.png](/assets/wiki/images/projection_viewport_camera_corrected_view.png)
...
![images/projection_viewport_camera_corrected_coordinate.png](/assets/wiki/images/projection_viewport_camera_corrected_coordinate.png)
...
![images/projection_viewport_camera_sprite.png](/assets/wiki/images/projection_viewport_camera_sprite.png)
...
![images/projection_viewport_camera_two_squares.png](/assets/wiki/images/projection_viewport_camera_two_squares.png)
...
![images/projection_viewport_camera_perspective.png](/assets/wiki/images/projection_viewport_camera_perspective.png)
...
![images/projection_viewport_camera_portrait.png](/assets/wiki/images/projection_viewport_camera_portrait.png)
...
![images/projection_viewport_camera_locked_portrait.png](/assets/wiki/images/projection_viewport_camera_locked_portrait.png)

![images/projection_viewport_camera_locked_landscape.png](/assets/wiki/images/projection_viewport_camera_locked_landscape.png)
